...
class UserInfo(val username:String,val password:String,val key:ByteArray,val doZip:Boolean = false,val offset:Int = 0,val multipleMode:Boolean = true,val limitation:Long = -1L){
  fun secret():String{
